...
# VTK 库路径
#LIBS += -D:/VTK/VTK-9.3.0-new/VTK-9.3.0-Install/bin/vtkIOOCCT-9.3.dll
#LIBS += -D:/VTK/VTK-9.3.0-new/VTK-9.3.0-Install/bin/vtkIOOCCT-9.3d.dll


CONFIG(debug, debug|release) {
# 设置vtk头文件目录
INCLUDEPATH = D:/VTK/VTK_build/include/vtk-9.3/
LIBS+= -L$$quote("D:/VTK/VTK_build/lib/")
